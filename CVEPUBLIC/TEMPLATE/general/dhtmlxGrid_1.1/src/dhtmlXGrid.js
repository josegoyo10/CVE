...
To use this component not under GNU GPL please contact info@scbr.com to obtain license
$CVSHeader: cvecolombia/CVEPUBLIC/TEMPLATE/general/dhtmlxGrid_1.1/src/dhtmlXGrid.js,v 1.3 2008/10/29 15:17:13 jlopez Exp $
*/
...
function dhtmlXGridObject(id){
   ...
   this.rowsBuffer = new Array(new Array(0),new Array(0));//buffer of rows loaded, but not rendered (array of ids, array of cell values arrays)
...
/*EVENTS*/
   ...
   this.onEditCell = this.entBox.oneditcell || function(){return true;};//fl,rid,cInd
   this.onRowSelect = this.entBox.onrowselect || function(){return true;};//rId,false
   this.onEnter = this.entBox.onenter || function(){return true;};//rId,cin
...
//         var r = this._addRow(,,-1,this.rowsCol.length,)//nb:paging
      //select row
   ...
   */
   this.clearAll = function(){
                     ...
                     for(var i=len-1;i>=0;i--){
                        this.obj.firstChild.removeChild(this.obj._rows(i))//nb:this.obj.rows[i].removeNode(true);
                     }
                     //..
                     this.row = null;
                     this.cell = null;
