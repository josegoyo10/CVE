...
$MY_DOCUMENT_ROOT = $mosConfig_absolute_path.$editor_fm_doc_root;

/*
 MY_BASE_URL
 Not used in htmlarea3-plugin version
*/
$MY_BASE_URL = $mosConfig_live_site.$editor_fm_base_url;
...
*/
$MY_URL_TO_OPEN_FILE         = $mosConfig_live_site.$editor_fm_base_url;
...
*/
$MY_ALLOW_EXTENSIONS        = explode(',', $editor_fm_allow_ext);
$MY_DENY_EXTENSIONS         = explode(',', $editor_fm_deny_ext);
...
*/
$MY_MAX_FILE_SIZE                 = $editor_fm_max_size*1024*1024;
