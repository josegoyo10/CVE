...
<body onload="Init()">
        <div class="title"><?php echo _filemanager_selectfolder ?></div>
        <form action="">
                <div class="elements">
                        <label for="newpath">
                ...
                <div style="text-align: right;">
                         <hr />
                        <button type="button" class="buttons" onclick="return onCancel();"><?php echo _filemanager_cancel ?></button>
                        <button type="button" class="buttons" onclick="return onOK();"><?php echo _filemanager_ok ?></button>
                </div>
        </form>
        <script type="text/javascript">
        /*<![CDATA[*/
