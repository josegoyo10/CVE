...
$isAdmin=False;
$isUser=False;
$fm_upload_auth=False;
$fm_new_folder_auth=False;
$fm_move_auth=False;
$fm_delete_auth=False;
$fm_rename_auth=False;
...
if (!$isAdmin) {
     ...
     $fm_upload_auth=checkType('FM_upload');
     $fm_new_folder_auth=checkType('FM_new_folder');
     $fm_move_auth=checkType('FM_move');
     $fm_delete_auth=checkType('FM_delete');
     $fm_rename_auth=checkType('FM_rename');
   }
...
<body onload="Init();">
                        ...
                        <div id="loading" style="position:absolute; left:200px; top:130px; width:184px; height:48px; z-index:1" class="statusLayer">
                          ...
                          <fieldset>
                                <legend>
                                        ...
                                        '<span style="font-size:x-small; "> - '._filemanager_ctrlshift.'</span>';
                                        ?>
                                </legend>
                                <div style="margin:5px;">
                                        ...
                                        <?php
                                                echo '<a href="#" onClick="javascript:goUpDir();"><img src="img/btn_up.gif" width="18" height="18" border="0" title="'._filemanager_up.'" /></a>';
                                                if (($fm_new_folder_auth || $isAdmin) && $MY_ALLOW_CREATE) {
                                                        echo '<a href="#" onClick="javascript:newFolder();"><img src="img/btn_create.gif"  width="18" height="18" border="0" title="'._filemanager_newfolder.'" /></a>';
                                                }
                                                if (($fm_delete_auth || $isAdmin) && $MY_ALLOW_DELETE) {
                                                        echo '<a href="#" onClick="javascript:deleteFile();"><img src="img/btn_delete.gif" width="18" height="18" border="0" title="'._filemanager_delete.'" /></a>';
                                                }
                                                if (($fm_rename_auth || $isAdmin) && $MY_ALLOW_RENAME) {
                                                        echo '<a href="#" onClick="javascript:renameFile();"><img src="img/btn_rename.gif" width="18" height="18" border="0" title="'._filemanager_rename.'" /></a>';
                                                }
                                                if (($fm_move_auth || $isAdmin) && $MY_ALLOW_MOVE) {
                                                        echo '<a href="#" onClick="javascript:moveFile();"><img src="img/btn_move.gif" width="18" height="18" border="0" title="'._filemanager_move.'" /></a>';
                                                }
                                                echo '<a href="#" onClick="javascript:openFile();"><img src="img/btn_open.gif"  width="18" height="18" border="0" title="'._filemanager_openfile.'" /></a>';
      ...
      <table border="0" align="center" cellpadding="2" cellspacing="2">
          <tr>
            <td nowrap><div align="right"><?php echo _filemanager_url ?> </div></td>
            <td><input name="url" id="f_url" type="text" style="width:20em" size="30"></td>
            <td nowrap><div align="right"><?php echo _filemanager_caption ?> </div></td>
          ...
          <tr>
            <td>
             <input id="f_addicon" value="f_addicon" type="checkbox">
                                ...
                                <div align="left"><?php echo _filemanager_file_type ?> </div>
                        </td>
                       <td>
                               <input id="f_addsize" value="f_addsize" type="checkbox">
            </td><td>
                                <div align="left"><?php echo _filemanager_file_size ?> </div>
                        </td>
                       <td>
                               <input id="f_adddate" value="f_adddate" type="checkbox">
            </td><td>
                                <div align="left"><?php echo _filemanager_file_date ?> </div>
                        </td>
                  </tr>
      </table>
                    ...
                    <?php
                        ...
                        ?>
                         ...
                         <div style="text-align: right; margin-top:5px;">
                                  ...
                                  <input type="button" name="ok" value="<?php echo _filemanager_ok ?>" onclick="return onOK();">
                     </div>
