 ...
 */
        ...
        function selectImage(filename, alt, width, height, thumb, thumbWidth, thumbHeight)
        {
                var topDoc = window.top.document;
                var formObj = window.top.document.forms[0];

                if (topDoc.getElementById('onmouseover').disabled == false && topDoc.getElementById('f_url').value != ""){
                  var obj = topDoc.getElementById('onmouseover');  obj.value = filename;
                }else {
                       ...
                       var obj = topDoc.getElementById('original_width'); obj.value = width;
                       var obj = topDoc.getElementById('original_height'); obj.value = height;
                       if (topDoc.getElementById('onmouseout').disabled == false){
                           var obj = topDoc.getElementById('onmouseout');  obj.value = filename;
                       }
                       var obj = topDoc.getElementById('popupthumb');  obj.value = thumb;
                       var obj = topDoc.getElementById('thumbWidth');  obj.value = thumbWidth;
                       var obj = topDoc.getElementById('thumbHeight');  obj.value = thumbHeight;
                }
        }
