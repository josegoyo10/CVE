                ...
                switch ($action)
                {
                        ...
                        case 'save':
                            ...
                            if($quality <0) $quality = 85;
                                        ...
                                        if ($this->manager->config['thumbs'] == 'true'){
                                            $thumbnail = $this->manager->getThumbName($newSaveFullpath);
                                            $thumbnailer = new Thumbnail($this->manager->config['thumbnail_width'],$this->manager->config['thumbnail_height']);
                                            $thumbnailer->createThumbnail($newSaveFullpath, $thumbnail);
                                            //End Thumbnails
                                        }
