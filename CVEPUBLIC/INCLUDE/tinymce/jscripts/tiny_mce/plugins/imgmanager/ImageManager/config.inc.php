...
require_once ($base_path."mambots/editors/tinymce_exp/jscripts/tiny_mce/exp_config.php");
...
*/
$IMConfig['base_dir'] = $mosConfig_absolute_path.$editor_im_base_dir;
...
*/
$IMConfig['base_url'] = $mosConfig_live_site.$editor_im_base_url;

/* Added by Ryan Demmer Dec 2004
Image path relative to Site URL. ImageManager strips this off for some reason. We need to put it back!
*/

$IMConfig['img_url'] = $mosConfig_live_site.$editor_im_base_url;
...
define('IMAGE_CLASS', $editor_im_image_class);
...
define('IMAGE_TRANSFORM_LIB_PATH', $editor_im_class_path);
...
*/
$IMConfig['thumbnail_prefix'] = $editor_im_thumb_prefix;
...
*/
$IMConfig['thumbnail_dir'] = $editor_im_thumb_dir;

/*
Moved to TinyMCE mambot parameters - Ryan Demmer Dec 2004
...
*/
$IMConfig['thumbnail_width'] = $editor_im_thumb_width;
$IMConfig['thumbnail_height'] = $editor_im_thumb_height;

$IMConfig['thumbs'] = $editor_im_thumbs;
//For resizing Images on upload
$IMConfig['quality'] = 100;
/*
Max Image dimensions
*/
$IMConfig['max_width'] = $editor_im_max_width;
$IMConfig['max_height'] = $editor_im_max_height;
/*
