...
$MiTemplate->set_file("main", TEMPLATE ."reportes/reporte_ventas_vendedor.htm");
...
if ($_REQUEST['accion'] == 'ver') {
	...
	//Cuerpo del reporte
	$MiTemplate->set_file("reportedetalle", TEMPLATE ."reportes/reporte_ventas_vendedor_detalle.htm");
