...
class adLDAP {
	...
	var $_account_suffix="@cencosud.corp";
	var $_base_dn = "DC=cencosud,DC=corp"; 
	
	// An array of domain controllers. Specify multiple controllers if you 
	// would like the class to balance the LDAP queries amongst multiple servers
	var $_domain_controllers = array ("cencosud.corp");
	
	// optional account with higher privileges for searching
	// not really that optional because you can't query much as a user
	// Por defetcto, autentica contra el LDAP de Cencosud (AIO)
	var $_ad_username="SEKB_LDAP_READER";
	var $_ad_password="XXXXXXX";
	...
	var $_conn;
	var $_bind;
  // file_put_contents('functionadLDAP.txt', 'functionadLDAP');
	...
	function adLDAP($options=array()){
        ...
        // file_put_contents('usuario.txt', $this->_ad_username);
        // file_put_contents('Contraseña.txt', $this->_ad_password);

		//echo 'Usuario: '.$this->_ad_username.' ';
    	//echo 'Contraseña: '.$this->_ad_password.'';
   ...
   //file_put_contents('authenticate.txt','autentica');
