...
/* Inclusi?n de main*/
$MiTemplate->set_file("main", TEMPLATE . "ordenent/orden_entrega_prov_fct.htm");
/**/
/*para los documentos*/
...
if (!$ListEnc->isvoid()) {
	do {
		...
		$MiTemplate->set_var('totalneto', round($ListEnc->getelem()->totalnum));
		$MiTemplate->set_var('valoriva', round($ListEnc->getelem()->totaliva));
		$MiTemplate->set_var('sumtotal', round($ListEnc->getelem()->totalnumiva));
