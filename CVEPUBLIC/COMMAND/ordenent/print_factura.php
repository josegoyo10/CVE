...
///////////////////////// ZONA DE ACCIONES /////////////////////////
	...
	$documentos=split('-',$_REQUEST['documentos']);
   	for($i=0;$documentos[$i];$i++) {
		...
		$prorrateoflete=1;   		
		bizcve::getdocumentoprn($Listdoc = new connlist(new dtodocumento(array('id_documento'=>$id_documento,'prorrateoflete'=>$prorrateoflete))));
        general::inserta_tracking(null, $id_ordenent, null, null, 'Se ha impreso Factura para la Orden de Entrega');
		$Listdoc-> gofirst();
