...
if ($_POST['accion'] == 'grabar') {
	...
	//$encCotizacion ->razonsoc		= $_POST['razon_soc'];
...
/****** MODIFICACION GOA 27-12-2007. Desde ahora el pventa+iva será guardo en la base de datos*****/
	...
	if (!bizcve::putcotizacion($listaEnc,$listaDet)) 
	{
		...
		general::inserta_tracking( $id_cotizacion, null, null, null, "La cotizacion ha cambiado a estado Cotizacion Activa");	
	    }
...
$listaEnc -> gofirst();
if($listaEnc->getelem()->codlocalventa != $ses_usr_codlocal  && !isset($_REQUEST['np'])){
?>
...
// Agregamos el main
$MiTemplate->set_file("main", TEMPLATE."nuevacotizacion/nueva_cotizacion_03pege.html");
