...
class dtobusavanzada {
	...
	function __construct($arrelem = null) {
		...
		$this->arreglo['cod_barra']   = null;
		$this->arreglo['des_larga']   = null;
		$this->arreglo['unid_med']    = null;
		$this->arreglo['prec_valor']  = null;
		$this->arreglo['razsoc_prov'] = null;
