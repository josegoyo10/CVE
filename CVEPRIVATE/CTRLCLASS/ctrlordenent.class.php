...
class ctrlordenent{
    ...
    public function getordenentan($ListEnc) {
      try {   
          $obj = new daoordenent;
          $obj->getencordenentan($ListEnc);
          if ($ListEnc->numelem()==1 && $ListDet!=null) {
        $ListEnc->gofirst();
            $ListDet->clearlist();
            $Registro = new dtodetordenent;
  ...
  public function getordenentsapflujo5($ListEnc, $ListDet = null) {
    ...
    private function putordenent($ListEnc, $ListDet, $fecha_rc, $fecha_ei, $fecha_dp,$valor_margen) {
      try {

         file_put_contents("putordenent19.txt", "paso putO");

        $ListEnc->gofirst();
      $RegVend= new dtousuario(array( 'id_tipousuario' => '1,2,3', /*Tipo Usuario Vendedor*/
      ...
      $ctrlus->GetUsers($ListVend);
        ...
        if (!$ListVend->numelem())
          ...
          file_put_contents("saveOrdenOE.txt", print_r($ListEnc,true));
        if (!$obj->saveencordenent($ListEnc, $fecha_rc, $fecha_ei, $fecha_dp,$valor_margen)) {
            $obj->rollback();
          return false;
        }
  ...
  public static function putean($cod_barra_os, $cod_ordenente){
    ...
    public function reservadisponible($listoe) {
      ...
      if ($listoeorig->getelem()->id_estado != 'OB' && $listoeorig->getelem()->id_estado != 'OM' && $listoeorig->getelem()->id_estado != 'OA' && $listoeorig->getelem()->id_estado != 'OG') {
...
//          } 
    ...
    public function generaordenent($listnve, $listpcant, $listoegen, $fecha_rc, $fecha_ei, $fecha_dp,$valor_margen) {
      try {
     ...
     // file_put_contents("estadoORdenENtrega.txt",$listnve->getelem()->id_estado);
...
////////////////////////////////////////////      
      ...
      if ($countterretin) { //Se inserta la OE de retira cliente inmediato
        ...
        //Ingreso la OE
           ...
           $fecha_c='0000-00-00';
           $fecha_d='0000-00-00';
           file_put_contents("ctrlFuncionput.txt", "pase por aqui");

          $this->putordenent($listoeencretin, $listoedetretin, $fecha_c, $fecha_ei, $fecha_d,$valor_margen);
            $listoeencretin->gofirst();
...
/*        if ($listoeencretin->getelem()->id_estado!='OB'){
        ...
        $listoegen->addlast($listoeencretin->getelem());
                  ...
                  $this->putordenent($listoeencretin, $listoedetretin, $fecha_rc, $fecha_ei, $fecha_dp,$valor_margen);
...
/*        if ($listoeencretin->getelem()->id_estado!='OB'){
      ...
      if ($countterret) { //Se inserta la OE de retira cliente posterior
        ...
        if($fecha_ei != '0000-00-00' || $fecha_dp !='0000-00-00' ){
          $fecha_e='0000-00-00';
            $fecha_d='0000-00-00';
          //Ingreso la OE
          $this->putordenent($listoeencret, $listoedetret, $fecha_rc, $fecha_e, $fecha_d,$valor_margen);
          $listoeencret->gofirst();
          //Ingreso el registro en el tracking
        ...
        $listoegen->addlast($listoeencret->getelem());
             ...
             file_put_contents("listoeencret.txt", print_r($listoeencret,true));
             file_put_contents("listoedetret.txt", print_r($listoedetret,true));



            $this->putordenent($listoeencret, $listoedetret, $fecha_rc, $fecha_ei, $fecha_dp,$valor_margen);
          $listoeencret->gofirst();
          //Ingreso el registro en el tracking
          general::inserta_tracking($listnve->getelem()->id_cotizacion, $listoeencret->getelem()->id_ordenent, null, null, 'Se ha creado una nueva Orden de Entrega');
          //Actualizo cantidades en la NVE original
      ...
      if ($countterdesp) { //Se inserta la OE de despacho a domicilio
        ...
        if($fecha_ei != '0000-00-00' || $fecha_rc !='0000-00-00' ){
          ...
          $fecha_c = '0000-00-00';
          //Ingreso la OE
          $this->putordenent($listoeencdesp, $listoedetdesp, $fecha_c, $fecha_e, $fecha_dp,$valor_margen);
          $listoeencdesp->gofirst();
          //Ingreso el registro en el tracking
        ...
        $listoegen->addlast($listoeencdesp->getelem());
              ...
              file_put_contents("listoeencdesp.txt", print_r($listoeencdesp,true));
              file_put_contents("listoedetdesp.txt", print_r($listoedetdesp,true));




            $this->putordenent($listoeencdesp, $listoedetdesp, $fecha_rc, $fecha_ei, $fecha_dp,$valor_margen);
...
/*DESPACHO PROVEEDOR*/
      if ($countterprov) { //Se inserta la OE de despacho proveedor
        ...
        //Ingreso la OE
        $this->putordenent($listoeencprov, $listoedetprov, $fecha_rc, $fecha_ei, $fecha_dp,$valor_margen);
        $listoeencprov->gofirst();
        //Ingreso el registro en el tracking
...
///////////////////////////////////////////////     
  ...
  public function putPagoOE($listoe, $listopgen, $caden3) {
      ...
      //Validar tipo de facturaci󮊉    /*if (!$listoe->getelem()->id_tipoflujo) throw new CTRLException('La Orden de Entrega no tiene asignado tipo de facturaci󮧬 2);*/
      ...
      if ($listoeorig->getelem()->id_estado == 'OM') return 'La Orden de Entrega esta en estado Bloqueada Manualmente';
      ...
      do {
        ...
        if( $listoeorig2->getelem()->id_tipoentrega == 2){
          //Modificaci󮠒GM 21.12.2006. Para flujo 3, se generan tantas OP como facturas
          //Agregamos la las de detalle
          $contadordes++;
      ...
      //Ingresamos la OP despacho domicilio si es que qued󠲥sto de las ya generadas
      if ($contadordes) {
      ...
      //Hago el cargo al disponible s󬯠si es cliente SAP
/*      $ctrlcte = new ctrlinfocliente();
      $ctrlcte->getCliente($listcte = new connlist(new dtoinfocliente(array('rut'=>$listoeorig->getelem()->rutcliente))));
      $listcte->gofirst();
    ...
    public function autorizaroe($listoe) {
      ...
      if (!$listoeorig || !$listoeorig->numelem()) 
        ...
        //Validar estado de la OE
      if (($listoeorig->getelem()->id_estado != 'OB') && ($listoeorig->getelem()->id_estado != 'OM'))
  ...
  public function bloquearoemanual($listoe) {
    global $ses_usr_login;
    try {
      ...
      $obj = new daoordenent;
      $retorno = $obj->saveencordenent(new connlist(new dtoencordenent(array(   'id_ordenent' => $listoe->getelem()->id_ordenent
                                          , 'id_estado' => $listoe->getelem()->id_estado
                                          , 'obsdesb' => 'Bloqueado manualmente por ' . $ses_usr_login . '.'))));
      return $retorno;
    }
    catch(CTRLException $e) {throw new BUSException($e->getMessage(), $e->getCode());}
      catch(DAOException $e)  {throw new SYSException(__CLASS__ , __FUNCTION__ , $e->getMessage(), $e->getCode(), 3);}
  ...
  public function oe_divi_producospos($ListDet) {
        try {
         $obj = new daoordenent;
          $obj->oe_divi_producospos($ListDet);
          return true ;
      }
      catch(CTRLException $e) {throw new BUSException($e->getMessage(), $e->getCode());}
      catch(DAOException $e)  {throw new SYSException(__CLASS__ , __FUNCTION__ , $e->getMessage(), $e->getCode(), 3);}
